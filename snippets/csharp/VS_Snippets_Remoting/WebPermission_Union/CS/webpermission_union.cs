...
// </Snippet1>
        ...
        Console.WriteLine("Attributes and values of the second WebPermission are:");
        PrintKeysAndValues(myWebPermission2.ToXml().Attributes, myWebPermission2.ToXml().Children);

// <Snippet2>
        // Create another WebPermission that is the Union of previous two WebPermission instances.
        WebPermission myWebPermission3 = (WebPermission)myWebPermission1.Union(myWebPermission2);
        Console.WriteLine("Attributes and values of the WebPermission after the Union are:");
