...
// <Snippet1>
        ...
        myWebPermission1.AddPermission(
            NetworkAccess.Connect, 
            new Regex("http://www\\.contoso\\.com/.*", 
...
// <Snippet2>
        ...
        {
            Console.WriteLine("WebPermission2 is the Subset of WebPermission1");  
            myWebPermission3 = myWebPermission1;
        }
        else if (myWebPermission1.IsSubsetOf(myWebPermission2))
        {
            Console.WriteLine("WebPermission1 is the Subset of WebPermission2");
...
// </Snippet2>
        ...
        Console.WriteLine("Attributes and Values of third WebPermission instance are:");
