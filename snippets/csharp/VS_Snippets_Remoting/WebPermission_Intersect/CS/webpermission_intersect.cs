...
// <Snippet2>
        ...
        // Check whether if the callers higher in the call stack have been granted access permissions.
...
// </Snippet1>
        ...
        Console.WriteLine("Attributes and values of second 'WebPermission' instance are:");
...
// <Snippet3>
        ...
        Console.WriteLine("Attributes and Values of  the WebPermission instance after the Intersect are:");
