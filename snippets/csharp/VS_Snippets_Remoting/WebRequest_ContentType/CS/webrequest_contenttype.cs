/*  System.Net.WebRequest.ContentType, System.Net.WebRequest.ContentLength, System.Net.WebRequest.GetRequestStream
  This program demonstrates 'GetRequestStream' method , 'ContentLength' and 'ContentType' properties of 'WebRequestClass'.
...
//<Snippet3>
            ...
            Console.WriteLine($"The value of 'ContentLength' property before sending the data is {myWebRequest.ContentLength}");
			Console.WriteLine("Please enter the data to be posted to (http://www.contoso.com/codesnippets/next.asp) Uri");
...
//</Snippet1>
            ...
            Console.WriteLine($"The value of ContentLength property after sending the data is {myWebRequest.ContentLength}");
			Console.WriteLine("The string entered has been succesfully posted to the Uri.");
